...
SELECT TO_CHAR(consumoenergetico.horarioinicio, 'HH24:MI'),
TO_CHAR(consumoenergetico.horariofim, 'HH24:MI')
FROM consumoenergetico WHERE horarioinicio 
BETWEEN TO_DATE('10:00', 'HH24:MI') AND TO_DATE('17:00', 'HH24:MI') AND 
horariofim BETWEEN TO_DATE('18:00', 'HH24:MI') AND TO_DATE('21:00', 'HH24:MI');
...
BETWEEN TO_DATE ('11:21', 'HH24:MI') AND TO_DATE ('11:23', 'HH24:MI') AND horariofim 
BETWEEN TO_DATE ('18:33', 'HH24:MI') AND TO_DATE ('18:35', 'HH24:MI');

/*RF 3*/
INSERT INTO consumoenergetico values TO_DATE('29-Oct-18 14:34', 'DD-Mon-YY HH24:MI'), 
