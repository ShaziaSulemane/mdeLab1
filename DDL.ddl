...
CREATE TABLE proprietario (
    ...
    tipo_proprientario   VARCHAR2(100)
);
...
ALTER TABLE consumoenergetico
    ADD CONSTRAINT relation_12 FOREIGN KEY ( id_relacao )
        REFERENCES equipamentoeletrico_divisao ( id_relacao );

ALTER TABLE anomalia
    ADD CONSTRAINT relation_17 FOREIGN KEY ( id_consumoenergetico )
        REFERENCES consumoenergetico ( id_consumoenergetico );

ALTER TABLE edificio
    ADD CONSTRAINT relation_18 FOREIGN KEY ( id_proprietario )
