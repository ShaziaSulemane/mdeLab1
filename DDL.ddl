...
CREATE TABLE proprietario (
    ...
    nif_proprietario    VARCHAR2(9) NOT NULL,
    descricao_cliente   VARCHAR2(100) NOT NULL
);

ALTER TABLE proprietario ADD CONSTRAINT proprietário_pk PRIMARY KEY ( id_proprietario );
...
ALTER TABLE edificio
    ADD CONSTRAINT relation_1 FOREIGN KEY ( id_tarifa )
...
ALTER TABLE edificio
    ADD CONSTRAINT relation_14 FOREIGN KEY ( id_proprietario )
        REFERENCES proprietario ( id_proprietario );

ALTER TABLE consumoenergetico
    ADD CONSTRAINT relation_15 FOREIGN KEY ( id_relacao )
        REFERENCES equipamentoeletrico_divisao ( id_relacao );
